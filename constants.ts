import type { Dhikr, DuaCategory, Profile, Settings, PrayerMethod, PopularReciter, SunnahCategory, AchievementId } from './types';
...
export const HISNUL_MUSLIM_DUAS: DuaCategory[] = [
  ...
  },
  {
    ...
    "duas": [
      ...
      { "ID": 2075, "ARABIC_TEXT": "اللَّهُمَّ اغْفِرْ لِي مَا قَدَّمْتُ وَمَا أَخَّرْتُ، وَمَا أَسْرَرْتُ وَمَا أَعْلَنْتُ، وَمَا أَنْتَ أَعْلَمُ بِهِ مِنِّي، أَنْتَ الْمُقَدِّمُ وَأَنْتَ الْمُؤَخِّرُ، وَأَنْتَ عَلَى كُلِّ شَيْءٍ قَدِيرٌ", "LANGUAGE_ARABIC_TRANSLATED_TEXT": "متفق عليه", "TRANSLATED_TEXT": "" },
...
export const REMINDER_INTERVALS: { value: number, label: string }[] = [
    { value: 30, label: 'كل 30 دقيقة' }, { value: 60, label: 'كل ساعة' }, { value: 120, label: 'كل ساعتين' }, { value: 240, label: 'كل 4 ساعات' },
];

export const POPULAR_RECITERS_YOUTUBE: PopularReciter[] = [
    { name: 'ياسر الدوسري', style: 'تلاوة خاشعة ومؤثرة', imageUrl: 'https://i1.sndcdn.com/avatars-000574514234-n2yux6-t500x500.jpg', youtubeQuery: 'تلاوة ياسر الدوسري' },
    { name: 'إسلام صبحي', style: 'صوت هادئ ومريح للنفس', imageUrl: 'https://i1.sndcdn.com/avatars-000622793132-6gbs8v-t500x500.jpg', youtubeQuery: 'تلاوة اسلام صبحي' },
    { name: 'عبدالرحمن السديس', style: 'إمام الحرم المكي', imageUrl: 'https://upload.wikimedia.org/wikipedia/commons/thumb/c/c9/Al-Sudais-1428-After-making-Dua.jpg/1200px-Al-Sudais-1428-After-making-Dua.jpg', youtubeQuery: 'تلاوة عبدالرحمن السديس' },
    { name: 'ماهر المعيقلي', style: 'إمام الحرم المكي', imageUrl: 'https://media.assettype.com/sabq%2F2023-06%2F590c9b74-a4dc-4a7b-bd4e-862d26f03a6a%2F%D8%A7%D9%84%D9%85%D8%B9%D9%8A%D9%82%D9%84%D9%8A.jpeg?w=1200&auto=format%2Ccompress&fit=max', youtubeQuery: 'تلاوة ماهر المعيقلي' },
    { name: 'مشاري العفاسي', style: 'صوت عذب وأداء مميز', imageUrl: 'https://www.aljazeera.net/wp-content/uploads/2023/03/33BV4H6-highres.jpg', youtubeQuery: 'تلاوة مشاري العفاسي' },
    { name: 'ناصر القطامي', style: 'تلاوة مؤثرة ومبكية', imageUrl: 'https://i.ytimg.com/vi/Ia-x9mD128U/maxresdefault.jpg', youtubeQuery: 'تلاوة ناصر القطامي' },
];
